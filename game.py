...
class GainzBattlesGame:
    def __init__(self):
        ...
        self.max_players = 4
        self.round_number = 0
        self.test_player_id = None  # For testing
    ...
    def add_test_player(self):
        """Adds a fake test player for solo testing"""
        if len(self.players) >= self.max_players:
            return False
        
        test_id = 999999999  # Fake ID
    ...
    async def play_card(self, interaction: discord.Interaction, card_index: int, stat: str):
        ...
        # Auto-play for Test Player if they haven't played
        if self.test_player_id and self.test_player_id not in self.played_cards and self.test_player_id in self.players:
    ...
    async def auto_play_test_player(self, interaction: discord.Interaction, stat: str):
        """Test player automatically plays a random card"""
